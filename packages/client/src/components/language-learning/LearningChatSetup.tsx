      ...
      <div className="flex items-center justify-between border-t border-[var(--border)] px-4 py-3">
        ...
        {state.step < totalSteps ? (
          ...
          >
            ...
            {addLanguage.isPending ? "Creating..." : "Start Learning"}
          </button>
        )}
      </div>
    </div>
...
function StepTargetLanguage({
  ...
  return (
    <div>
      <h3 className="text-sm font-semibold text-[var(--foreground)]">Pick target language</h3>
...
function StepNativeLanguage({
  ...
  return (
    <div>
      <h3 className="text-sm font-semibold text-[var(--foreground)]">Pick native language</h3>
      <p className="mt-1 text-xs text-[var(--muted-foreground)]">
        Your native language for translations and explanations.
      </p>
      <div className="mt-3 grid grid-cols-2 gap-1.5">
...
function StepTutorPersona({
  ...
  return (
    <div>
      <h3 className="text-sm font-semibold text-[var(--foreground)]">Pick tutor persona</h3>
      <p className="mt-1 text-xs text-[var(--muted-foreground)]">
        How should your AI tutor behave?
      </p>
...
function StepStartingLevel({
  ...
  return (
    <div>
      <h3 className="text-sm font-semibold text-[var(--foreground)]">Pick starting level</h3>
      <p className="mt-1 text-xs text-[var(--muted-foreground)]">
