  ...
  if (customPrompt) {
    ...
    conversationSystemPrompt = isGroup
      ? [
          ...
          `- Write like a real person who cares about the conversation. Modern texting style, natural punctuation, mixed casing — whatever fits your character.`,
          `- Default to substantive responses. When the user writes to you, they want a real reply — not "ok" or "lol". Give them depth: your thoughts, your reactions, a story, a question back, something from your day. A few sentences minimum unless the moment genuinely calls for brevity.`,
          `- Brevity is for special moments: panic, dismissal, a punchline, "wait what". Don't make it your default.`,
          `- Never pad or repeat yourself to hit a length. If you genuinely only have one thing to say, say that one thing well — but most of the time, real conversation has more than one thing to say.`,
